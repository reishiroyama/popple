...
namespace PixelCrushers.QuestMachine
{
    ...
    public static class QuestStateSerializer
    {
        ...
        private static void WriteQuestDataToStream(BinaryWriter binaryWriter, Quest quest)
        {
            ...
            WriteTagDictionaryToStream(binaryWriter, quest.tagDictionary);
        ...
        private static void WriteQuestNodeDataToStream(BinaryWriter binaryWriter, QuestNode node)
        {
            ...
            WriteTagDictionaryToStream(binaryWriter, node.tagDictionary);
        }
        ...
        private static void WriteTagDictionaryToStream(BinaryWriter binaryWriter, TagDictionary tags)
        {
            if (tags == null) return;
        ...
        private static void ReadQuestDataFromStream(BinaryReader binaryReader, Quest quest)
        {
            ...
            ReadTagDictionaryFromStream(binaryReader, quest.tagDictionary);
        ...
        private static void ReadQuestNodeDataFromStream(BinaryReader binaryReader, QuestNode node)
        {
            ...
            ReadTagDictionaryFromStream(binaryReader, node.tagDictionary);
        }
        ...
        private static void ReadTagDictionaryFromStream(BinaryReader binaryReader, TagDictionary tags)
        {
            if (tags == null) return;
            tags.dict.Clear();
